# vuestacks-chat-mevn-vuex-okta-auth
...
The VueStacks chat MEVN demo utilizes Vuex, Vue-Router, Axios HTTP client, Express server, and Mongoose.js to post messages in a chatroom. 
